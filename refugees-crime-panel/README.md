...
기본 Two-Way Fixed Effects 분석에서는 재산범죄율에서 양의 상관관계가 나타났습니다. 하지만 폭력범죄, 마약범죄, 성범죄에서는 일관된 양의 관계를 확인하기 어려웠습니다.
...
- `00_prepare_panel.py`  
  원자료를 불러와 인구 10만 명당 비율, 로그 변수를 생성합니다.
...
재산범죄율에서는 약 0.058의 양의 계수가 나타났고, 통계적으로 유의했습니다.
...
> 기본 TWFE에서는 재산범죄율에서 양의 상관관계가 관찰되지만, lead placebo와 국가별 추세를 고려하면 이를 난민 유입의 강건한 인과효과로 해석하기 어렵다.  
...
기본 TWFE 결과만 보면 재산범죄율에서 양의 관계가 나타났습니다. 하지만 민감한 사회적 주제에서 기본 회귀 결과 하나만으로 결론을 내리는 것은 위험하다고 판단했습니다.
