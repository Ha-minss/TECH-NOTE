...
def main() -> None:
    ...
    summary.to_csv(reports / "ab_group_summary.csv")
    summary.to_csv(tables / "ab_group_summary.csv")
    distribution.to_csv(reports / "revenue_distribution_summary.csv")
    ...
    sensitivity.to_csv(reports / "whale_sensitivity_summary.csv", index=False)
    sensitivity.to_csv(tables / "whale_sensitivity_summary.csv", index=False)

    business = business_scenarios(comparison["arpu_diff"])
    business.to_csv(reports / "business_scenarios.csv", index=False)
    ...
    inference.to_csv(reports / "inference_summary.csv", index=False)
