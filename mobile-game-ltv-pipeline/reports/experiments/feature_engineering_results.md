...
- Best RMSLE improvement versus current_full: xgb_target_encoding_features (rmsle=0.540359, current_full delta=0.007231).
...
- Final feature set candidate: `xgb_target_encoding_features` for the next modeling stage, unless the business goal prioritizes top-decile capture over RMSLE.
